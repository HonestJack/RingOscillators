...
HD_PWD='C:/Users/mucar/OneDrive/Documentos/UFRGS/TCC/Kintex 2/Oscillator/Oscillator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OscillatorModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OscillatorModule.tcl -notrace
