-- =============================================================================
--  VHDL simulation model generated by IPExpress    08/17/2023    14:50:32         
--  Filename: ringoscillatorgenerate_la0_sim.vhd                                          
...
entity ringoscillatorgenerate_la0 is
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (3 downto 0);
        trigger_en:	IN std_logic;
        ip_enable:	IN std_logic
    );

end ringoscillatorgenerate_la0;

architecture ringoscillatorgenerate_la0_u of ringoscillatorgenerate_la0 is
begin

    er2_tdo <= '0';

end ringoscillatorgenerate_la0_u;
