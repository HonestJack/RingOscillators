...
HD_PWD='C:/Users/mucar/OneDrive/Documentos/UFRGS/TCC/Kintex 2/Oscillator/Oscillator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OscillatorModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OscillatorModule.tcl
